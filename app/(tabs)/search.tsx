        ...
        {!searchLoading && !searchError && search?.length > 0 && (
          <View className="mb-32">
              ...
              {searchFinished && (
                ...
                <FlatList
                  scrollEnabled={false}
                  data={data?.artists?.items.slice(0, 1)}
            ...
            {searchFinished && (
              ...
              <FlatList
                scrollEnabled={false}
                data={data?.tracks?.items.slice(0, 5)}
            ...
            <View className="flex-1 mt-1 ml-1 w-30 h-30">
              {searchFinished && (
                  <Text className='text-white self-center text-xl ml-5 mt-5'>Albums</Text>
              )}
              <FlatList
                scrollEnabled={false}
                data={data?.albums.items.slice(0, 6)}
                renderItem={({item}) => (
